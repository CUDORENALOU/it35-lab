import { 
  ...
  import { bookOutline, call, star } from 'ionicons/icons';
...
const Home: React.FC = () => {
  const tabs = 
  [
    {name:'Post', tab:'feed',url: '/it35-lab/app/home/feed', icon: bookOutline},
    {name:'Contact', tab:'search', url: '/it35-lab/app/home/search', icon: call},
